...
export function CategorySelection() {
  ...
  const handleCategoryClick = (categoryId: number) => {
    if (selectedCategory === categoryId) {
      // Close the form if clicking the same category
      setSelectedCategory(null);
      resetForm();
    } else {
      setSelectedCategory(categoryId);
      resetForm();
      // Fetch cities when form opens since we'll need them later
      if (cities.length === 0) {
        fetchCities();
      }
        ...
        {CATEGORY_CONFIG.map((category, index) => {
          ...
          return (
            <motion.button
              ...
              className={[
                ...
                isSelected
                  ...
                  : "hover:shadow-lg hover:-translate-y-2 border-gray-200",
              ].join(" ")}
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br from-gold-50 to-transparent transition-opacity ${
                  isSelected
                    ? "opacity-100"
                ...
                <div className="hidden md:flex flex-col gap-6 min-w-[200px]">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex flex-col items-center">
                      ...
                      >
                        {hasLicense ? <Check className="h-5 w-5" /> : "1"}
                      </div>
                      {/* Connector line */}
                      <div
                    ...
                    <div className="pt-2">
                      <p
                        className={`font-semibold text-sm ${
                          hasLicense ? "text-gold-600" : "text-gray-600"
                        }`}
                      >
                        License Status
                      </p>
                  ...
                  <AnimatePresence>
                    {experienceLevel && (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-600">
                          Choose the package type that best fits your schedule
                          and preferences
                        </p>
