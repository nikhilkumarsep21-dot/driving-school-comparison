        ...
        <div className="grid gap-8 py-12 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Find and compare the best driving schools in Dubai. Make an informed decision for your driver training.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-sm text-gray-600 transition-colors hover:text-gold-600">
                  All Schools
                </Link>
              </li>
              <li>
                <Link href="/compare" className="text-sm text-gray-600 transition-colors hover:text-gold-600">
                  Compare Schools
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold text-gray-900">License Types</h3>
            <ul className="space-y-2">
              <li className="text-sm text-gray-600">Light Vehicle</li>
              <li className="text-sm text-gray-600">Motorcycle</li>
              <li className="text-sm text-gray-600">Heavy Truck</li>
              <li className="text-sm text-gray-600">Bus</li>
            </ul>
          </div>
