...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: 'Excellent platform! Found the perfect driving school near my home. The comparison feature made it so easy to see pricing and reviews at a glance. Highly recommend!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'This website saved me so much time! I was able to compare all the driving schools in my area and read real student reviews. Passed my test on the first try!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Very user-friendly website with accurate information. The side-by-side comparison helped me choose the best school for my budget and schedule. Great experience overall!',
  ...
  },
  {
    ...
    location: 'Jumeirah',
    rating: 4.5,
    comment: 'Love how transparent the pricing is on this platform. No hidden fees or surprises. Found a great driving school with excellent instructors thanks to the verified reviews!',
  ...
  },
  {
    ...
    location: 'JBR',
    rating: 5,
    comment: 'The filtering options are fantastic! I could narrow down schools by location, price, and license type in seconds. Made my decision so much easier and stress-free.',
